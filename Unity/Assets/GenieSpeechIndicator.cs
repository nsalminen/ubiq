...
public class GenieSpeechIndicator : MonoBehaviour
{
    ...
    // Genie begins
    private IPlaybackStatsSource injectedStatsSource;
    private VoipPeerConnectionManager peerConnectionManager;

    public void InjectStatsSource(IPlaybackStatsSource statsSource)
    {
        this.injectedStatsSource = statsSource;
        enabled = true;
